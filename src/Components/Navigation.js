        ...
        <li className={style['nav__item']}>
          <Link href='/'>
            <a className={classNames(style['nav__link'], asPath === '/' && style["nav__link--active"])}>
              <Icon className={style['nav__link__icon']} icon='about' color='white' size='large' />
        ...
        <li className={style['nav__item']}>
          <Link href='/writing'>
            <a className={classNames(style['nav__link'], asPath === '/writing' && style["nav__link--active"])}>
              <Icon className={style['nav__link__icon' ]}icon='writing' color='white' size='large' />
        ...
        <li className={style['nav__item']}>
          <Link href='/work'>
            <a className={classNames(style['nav__link'], asPath === '/work' && style["nav__link--active"])}>
              <Icon className={style['nav__link__icon']} icon='work' color='white' size='large' />
        ...
        <li className={style['nav__item']}>
          <Link href='/contact'>
            <a className={classNames(style['nav__link'], asPath === '/contact' && style["nav__link--active"])}>
              <Icon className={style['nav__link__icon']} icon='contact' color='white' size='large' />
